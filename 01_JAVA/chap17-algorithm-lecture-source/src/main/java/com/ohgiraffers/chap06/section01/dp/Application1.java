...
/* 수업목표. 동적계획법(Dynamic Programming) 알고리즘을 활용하는 예제를 이해할 수있다. */
/* 필기.
...
public class Application1 {
    public static int solution(int N) throws Exception{
        ...
        /* 설명.
         *  5킬로그램까지는 앞의 if문에서 처리 했기 때문에 6킬로그램부터(5키로그램 이하는 1이 측정되어야 하므로 +1을 함)
         *  dp배열에 저장한다.(3키로그램에 대한 개념을 해당 DP에 저장한다.)
