...
public class Application4 {
    public static void main(String[] args) {
        ...
        memArr[0] = new MemberDTO("user01", "pass01", "홍길동", "hong777@ohgifraffers.com", 25, '남');
        memArr[1] = new MemberDTO("user02", "pass02", "유관순", "korea31@ohgifraffers.com", 16, '여');
        memArr[2] = new MemberDTO("user03", "pass03", "이순신", "leesoonsin@ohgifraffers.com", 22, '남');
        ...
        * */
        ...
        MemberDTO[] inputMember = new MemberDTO[memArr.length];
        ...
        try {
            ...
            int i = 0;
            while (true){
                inputMember[i] = (MemberDTO)(ois.readObject());
                i++;
            }
        ...
        for(MemberDTO each: inputMember){
            if(each == null) break;
