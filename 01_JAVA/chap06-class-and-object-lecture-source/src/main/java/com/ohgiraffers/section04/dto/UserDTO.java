 ...
 *   자바 코드를 모르는 웹 퍼블리셔들도 자바 코드를 사용할 수 있도록 태그 형식으로 지원하는 문법을 의마하는데,
...
/* 필기. DTO (Data Transfer Object) - 데이터 운송용 클래스 */
...
public class UserDTO {
    ...
    /* 설명. 이후 나머지 setter, ggtter는 단축카로 만들자. */
