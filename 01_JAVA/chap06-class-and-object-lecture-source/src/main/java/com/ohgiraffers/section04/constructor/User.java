...
public class User {
    ...
    /* 필기.
     *   생성자 작성 위치
     *    작성 위치는 문법상으로 클래스 내부에 필드 선언부 이후, 매소드 선언부 이전에 작성하는 것이 관례이다.
    * */
    public User(){
    ...
    public User(String id, String pwd, String name, Date enrollDatedate) {
...
//        this();                          // this()를 통한 다른 생성자 할용은 다른 하나의 생성자만 활용 가능하다.
        this(id, pwd, name);
        this.enrollDate = enrollDatedate;
