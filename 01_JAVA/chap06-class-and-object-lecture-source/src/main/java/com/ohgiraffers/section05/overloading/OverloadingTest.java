...
public class OverloadingTest {
     ...
     *
     * 필기.
     *   동일한 메소드 이름을 다양한 종류의 매개변수에 따라 처리해야 하는 경우 적용하는 기술을
     *   오버로딩이라고 한다.
     *
     * 필기.
     *  오버로딩의 조건?
     *   매개변수의 타입, 갯수, 순서를 다르게 작성하여 하나의 클래스 내에 동일한 이름의 매소드를
     *   여러 개 작성할 수 있다.
     *   매소드의 해드부에 있어 시그니처를 제외한 부분이 다르게 작성되는 것은 인정되지 않는다.
    * */
...
//    public void test(int num2, int num1) {}       // 변수명이 다른 것은 무관
    ...
    public void test(int num2, String str) {}

    /* 설명. 매개변수의 순서가 달라졌기 때문 */
    public void test(String str, int num2) {}
