...
public class Application {
    public static void main(String[] args) {
        ...
        /* 수업목표. 추상클래스와 추상매소드에 대해 이해할 수 있다. */
        /* 필기.
         *  추상클래스와 추상메소드
         *   추상메소드를 0개 이상 포함하는 클레스를 추상 클래스라고 한다.
         ...
         *  불완전한 메소드를 하나라도 가진 클레스는 반드시 추상 클래스가 되어야 한다.
...
//        Product product = new Product();
        ...
        /* 설명. abstract 메소드를 구혀ㅑㄴ한 온전한 자식 클래스는 인스턴드(객체)를 생성할 수 있다. */
