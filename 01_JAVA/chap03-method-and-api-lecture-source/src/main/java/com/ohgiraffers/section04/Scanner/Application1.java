...
//        System.out.println("입력하신 키는: " + height);
        ...
        /* 목차. 4. 논리형 입력받기 */
        System.out.println("참과 거짓 중에 한 가지를 true 또는 false로 입력하세요: ");
        ...
        /* 목차. 5. 문자형 입력받기 */
        System.out.printf("아무 문자나 입력 해주세요: ");
        char answer = sc.next().charAt(0);      // 메소드 체이닝 방식으로 사용자의 입력 값에서 인덱스 번째의 문자를 char형으로 반환
