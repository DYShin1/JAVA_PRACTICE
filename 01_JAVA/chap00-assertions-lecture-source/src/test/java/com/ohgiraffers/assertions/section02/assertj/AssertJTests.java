...
public class AssertJTests {
    ...
    /* 목차. 1. 문자열 테스트 하기 */
    /* 필기. 문자열의 패턴들로 거증을 하기 때문에 일치성 여부만 판단하는 것보다 다양한 테스트를 할 수 있다. */
    @Test
    ...
    /* 목차. 3. 날짜 테스트하기 */
    /* 필기. 날짜 객체가 가지는 년, 월, 일, 시, 분, 초, 밀리초, 나노초까지도 거증이 가능하며, 특정 날짜 범위, 이전, 이후 내용도 검증 가능하다. */
    @Test
    ...
    void testExceptionValidation(){
        Throwable thrown = AssertionsForClassTypes.catchThrowable(() -> {throw new IllegalArgumentException("잘못된 파라미터를 입력하셧습니다.");});
