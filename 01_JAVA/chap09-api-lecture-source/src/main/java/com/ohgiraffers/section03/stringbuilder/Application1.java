...
//        StringBuilder sb2 = "java";                   // StringBuilder는 문자열은 다루지만 리터럴은 다루지 않음
        System.out.println(sb);

        /* 설명. String과 StringBuilder로 주성 시 객체 주소값 변화 살펴보기 */
        String testStr = "java";
        ...
        for (int i = 0; i < 9; i++) {
             ...
             *  따라서 System.identityHashCode() 메소드를 활용해 String으로 괸리되는 문자열과 StringBuilder로
