...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        java.util.Date sqlDate = new java.sql.Date(today.getTime());        // java.util.Date를 long형으로 변환 sql

        java.util.Date sqlDate2 = (java.sql.Date)today;                     // 실제로는 uilt.Date형이었던 날짜형을 util.
                                                                            // Date형인 today에 담겨있었다면 이 방법도 가능하다.
