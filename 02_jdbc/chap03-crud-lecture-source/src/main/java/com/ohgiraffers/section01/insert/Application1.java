...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 설명.
         *  DML(insert, update, delete) 작업 시에는 반환 겨과가 inst값이 된다.(ResultSet을 쓰지 않는다.)
         *  그리고 기존의 조회일 때는 executeQuery()를 사용하지만 DML 작업 시에는 executeUpdate()를 사용함.
        * */
        int result = 0;

        String query = "INSERT INTO TBL_MENU (MENU_NAME, MENU_PRICE, CATEGORY_CODE, ORDERABLE_STATUS) " + "VALUE (?, ?, ?, ?)";
