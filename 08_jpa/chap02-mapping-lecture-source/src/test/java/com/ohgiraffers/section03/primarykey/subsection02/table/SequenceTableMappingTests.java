...
//        member2.setMemberNo(1);
        ...
        member2.setPhone("010-1231-1344");
...
//        Member selectedMemeber = entityManager.find(Member.class, 1);
//        System.out.println("selectedMemeber = " + selectedMemeber);

    String jpql = "SELECT A.memberNo FROM member_section03_subsection03 A";
